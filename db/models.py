...
from db.model_dependencies import (
    CardRarity,
    OrderStatus,
    GroupMemberStatus,
    Package,
...
class User(Model):
    ...
    continuous_check_in = fields.IntField(default=0, description="当前连续签到天数")
...
class Restaurant(Model):
    ...
    main_business = fields.CharEnumField(
        ...
        null=False,
        default=RestaurantBusiness.NOT_OPEN,
        description='餐馆经营类型，和可抽的卡牌包类型一致(base除外)'
    )
